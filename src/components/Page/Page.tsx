        ...
        return (
          <React.Fragment key={ann.id}>
            ...
            {isSelected && !isSyncing && (
              <div
                className="absolute z-50 bg-zinc-900 border border-zinc-700 shadow-xl rounded-lg p-2 transform -translate-x-1/2 -translate-y-[120%] min-w-[200px]"
                style={{
                  ...
                  <input
                    ...
                    onKeyDown={(e) => {
                      if (e.key === 'Enter') {
                        ...
                        if (val) {
                          updateAnnotationContent(index, ann.id, val);
